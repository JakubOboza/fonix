...
func TestSendSmsSuccessRequestID(t *testing.T) {

	expectedRequestBody := `BODY=Hey+man+this+is+a+test&NUMBERS=447123456767890&ORIGINATOR=1234567&REQUESTID=TEST123456REQID`
